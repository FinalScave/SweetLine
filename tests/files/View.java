...
public class View implements Drawable.Callback, KeyEvent.Callback, AccessibilityEventSource {
    ...
    public boolean dispatchNestedPrePerformAccessibilityAction(int action, @Nullable Bundle arguments) {
        throw new RuntimeException("Stub!");
    }
    ...
    public void dispatchScrollCaptureSearch(@NonNull Rect localVisibleRect, @NonNull Point windowOffset, @NonNull Consumer<ScrollCaptureTarget> targets) {
        throw new RuntimeException("Stub!");
    }
    ...
    public void dispatchCreateViewTranslationRequest(@NonNull Map<AutofillId, long[]> viewIds, @NonNull int[] supportedFormats, @NonNull TranslationCapability capability, @NonNull List<ViewTranslationRequest> requests) {
        throw new RuntimeException("Stub!");
    }

    public void generateDisplayHash(@NonNull String hashAlgorithm, @Nullable Rect bounds, @NonNull Executor executor, @NonNull DisplayHashResultCallback callback) {
        throw new RuntimeException("Stub!");
    }
    ...
    public interface OnAttachStateChangeListener {
        void onViewAttachedToWindow(@NonNull View var1);

        void onViewDetachedFromWindow(@NonNull View var1);
    }
